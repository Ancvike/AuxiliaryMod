...
public class Menu {
    ...
    public static Dialog dialog = new Dialog("功能面板") {{
        functions.addAll(new checkFunction(), new TeamChange(), new Invincibility(), new SpeedChange(), new NoLimitBlueprint(), new WarfareFog(), new FullResource(), new BuildingRestoration(), new UnitsRestoration(), new DerelictRemove(), new Launch(), new NoLimitZoom(), new CheckEnemy());
